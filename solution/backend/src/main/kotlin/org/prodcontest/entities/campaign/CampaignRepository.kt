    ...
    @Query(
        """
            ...
            ORDER BY
                ...
                COALESCE((SELECT nui.count FROM c.nonUniqueImpressions nui WHERE nui.client.id = :clientId), 0) * 1 ASC,
                ...
                (c.impressionsLimit - SIZE(c.impressions)) * 1 DESC,
                (c.clicksLimit - SIZE(c.clicks)) * 2 DESC,
